        ...
        <div className="text-left lg:w-2/3 mt-7 sm:mt-10 lg:my-auto mx-auto lg:pr-20 items-start">
            ...
            <form action='https://docs.google.com/forms/d/e/1FAIpQLSdvG-3uuAZlr_IZw_YT0SSOPylvC4-xMqLzD9OKSJmzD3kpPQ/formResponse' method='post' target="hidden_iframe" onSubmit={() => setSubmitted(true)} className="lg:w-2/3 mx-auto mt-0 w-2/3">
                ...
                className="relative z-0 w-full mb-5 group">
                    <input type="text" name="entry.1621349201" id="Name" className="block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b-2 appearance-none text-white border-gray-600 focus:outline-none focus:ring-0 focus:border-emerald-500 peer" placeholder=" " required readOnly={submitted} />
                ...
                <motion.div 
                    ...
                    transition = {{ duration:1, delay:0 }}
                className="relative z-0 w-full mb-5 group">
                    <input type="email" name="entry.1661846347" id="Email" className="block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b-2 appearance-none text-white border-gray-600 focus:outline-none focus:ring-0 focus:border-emerald-500 peer" placeholder=" " required readOnly={submitted} />
                ...
                <motion.div 
                    ...
                    transition = {{ duration:1, delay:0 }}
                className="relative z-0 w-full mb-5 group">
                    <textarea name="entry.592867916" id="Message" rows="4" className="block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b-2 appearance-none text-white border-gray-600 focus:outline-none focus:ring-0 focus:border-emerald-500 peer" placeholder=" " required readOnly={submitted}></textarea>
