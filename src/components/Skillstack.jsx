  ...
  return (
    <>
      ...
      <div className="skillstackcontent">
        <p>
          <strong className="highlight">Front-End Development</strong>
        </p>
        <p>
        ...
        <br />
        <p>
          <strong className="highlight">Back-End Development</strong>
        </p>
        <p>
        ...
        <br />
        <p>
          <strong className="highlight">Database Systems</strong>
        </p>
        <p>
